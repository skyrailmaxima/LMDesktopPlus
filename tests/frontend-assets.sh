...
grep -q 'store.js' "$STATIC/index.html"
grep -q 'tiles.js' "$STATIC/index.html"
...
grep -q 'this.wallpapers = new Map' "$STATIC/store.js"
grep -q 'class DiffRenderer' "$STATIC/store.js"
grep -q 'class AssetMap' "$STATIC/store.js"
grep -q 'class LiveStore' "$STATIC/store.js"
grep -q 'LMDPTiles' "$STATIC/tiles.js"
grep -q 'function renderTiles' "$STATIC/tiles.js"
grep -q 'function computeReorder' "$STATIC/tiles.js"
grep -q 'tiles.js' "$STATIC/../server.py"
grep -q 'function registerTiles' "$STATIC/app.js"
grep -q 'window.LMDPTiles.renderTiles("desktop"' "$STATIC/app.js"
grep -q 'window.LMDPTiles.renderTiles("monitor"' "$STATIC/app.js"
grep -q 'function gaugeSvg' "$STATIC/app.js"
grep -q 'function patchGauge' "$STATIC/app.js"
grep -q 'data-layout-edit' "$STATIC/app.js"
...
grep -q 'customization.greeting.rotate_seconds' "$STATIC/app.js"
